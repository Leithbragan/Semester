...
-- Дамп структуры для таблица tourism.book
CREATE TABLE IF NOT EXISTS `book` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `author` varchar(50) NOT NULL,
  `gener` varchar(50) DEFAULT NULL,
  `edition` int(4) DEFAULT NULL,
  `description` varchar(20000) DEFAULT 'описание отсутствует',
...
-- Дамп данных таблицы tourism.book: ~8 rows (приблизительно)
/*!40000 ALTER TABLE `book` DISABLE KEYS */;
INSERT INTO `book` (`id`, `name`, `author`, `gener`, `edition`, `description`, `price`, `pages`, `weight`) VALUES
	(1, 'Отцы и дети', 'Тургенев   И. С. ', 'Роман', 2015, '"Отцы и дети" - знаменитый роман Тургенева, ставший чуть ли не самым значительным произведением в истории о взаимоотношениях поколений. Споры главного героя Евгения Базарова, называющего себя нигилистом и отрицающего расхожие представления о жизни, искусстве, морали, природе человека, и его антагониста Павла Кирсанова, аристократа до мозга костей, составляют главную проблематику романа. ', 134, 288, 150),
	(2, 'Горе от ума', 'Грибоедова А. С.', 'Комедия', 2016, 'Комедия в стихах А. С. Грибоедова — произведение, сделавшее своего создателя классиком русской литературы. Она сочетает в себе элементы классицизма и новых для начала XIX века романтизма и реализма. Она описывает светское общество времен крепостного права и показывает жизнь 1808—1824-х годов. Само «действие происходит… спустя десять лет после войны 1812 года, то есть в 1822»', 132, 256, 200),
	(3, '451 градус по фаренгейту', 'Брэдбери   Р. Д. ', 'Антиутопия', 2015, '451° по Фаренгейту — температура, при которой воспламеняется и горит бумага. Философская антиутопия Брэдбери рисует беспросветную картину развития постиндустриального общества: это мир будущего, в котором все письменные издания безжалостно уничтожаются специальным отрядом пожарных, а хранение книг преследуется по закону, интерактивное телевидение успешно служит всеобщему оболваниванию, карательная психиатрия решительно разбирается с редкими инакомыслящими, а на охоту за неисправимыми диссидентами выходит электрический пес… ', 165, 238, 180),
	(4, 'Остров Крым', 'Аксенов   В. П.', 'Антиутопия', 2016, 'Знаменитая антиутопия Василия Аксёнова, принесшая автору мировую известность. В основе фабулы невероятное допущение: как могла повернуться история, если бы Крым не был захвачен большевиками, а остался свободным и независимым. В романе много приключений, гротескных житейских ситуаций. Несмотря на фантастический сюжет, книга во многом оказалась провидческой.', 190, 640, 408),
	(5, 'Вино из одуванчиков', 'Брэдбери   Р. Д. ', 'Фантастика', 2009, 'Войдите в светлый мир двенадцатилетнего мальчика и проживите с ним одно лето, наполненное событиями радостными и печальными, загадочными и тревожными; лето, когда каждый день совершаются удивительные открытия, главное из которых - ты живой, ты дышишь, ты чувствуешь! ', 164, 320, 236),
	(6, 'Анна Каренина', 'Толстой   Л. Н.', 'Роман', 2009, '"Анна Каренина", один из самых знаменитых романов Льва Толстого, начинается ставшей афоризмом фразой: "Все счастливые семьи похожи друг на друга, каждая несчастливая семья несчастлива по-своему". ', 272, 800, 500),
	(7, 'Маруся', 'Волков С. Ю.', 'Этногенез', 2012, 'Книга "Маруся" - первая из серии, в которой главная героиня - девочка, с которой постоянно что-то случается. Действие книги начинается в 2020 году на планете Земля.', 272, 264, 130),
	(8, 'Маруся2', 'Волков С. Ю.', 'Этногенез', 2012, 'Попав в глухую сибирскую тайгу, Маруся Гумилева оказывается в мире, совсем непохожем на тот, в котором она жила до сих пор. ', 292, 272, 134);
...
-- Дамп данных таблицы tourism.excursion_plan: ~39 rows (приблизительно)
...
-- Дамп данных таблицы tourism.excursion_trip: ~129 rows (приблизительно)
...
-- Дамп данных таблицы tourism.points: ~108 rows (приблизительно)
...
-- Дамп данных таблицы tourism.routes: ~81 rows (приблизительно)
...
-- Дамп данных таблицы tourism.users: ~19 rows (приблизительно)
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `role`, `firstname`, `lastname`, `locale`, `confirmed`, `active`, `uuid`, `deletedate`, `vote`, `vote_count`) VALUES
	(84, '11', '11111', 'zsn_90@mail.ru', 'SIGHTSEER', 'mr', 'mr', 'ru_RU', b'1', b'0', NULL, NULL, NULL, NULL),
	(85, '12', '121212', 'zsn_90@mail.ru', 'SIGHTSEER', '12', '12', 'ru_RU', b'1', b'0', NULL, NULL, NULL, NULL),
	(69, '1391809730', 'facebook', 'eljah@mail.ru', 'ADMIN', 'Ilya', 'Yevlampiev', 'en', b'1', b'1', NULL, NULL, NULL, NULL),
