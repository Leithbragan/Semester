        ...
        <div class="container-fluid">
            ...
            <c:if test="${user==null}">
                ...
                <form class="navbar-form navbar-right" action="login" method=post>
                    ...
                    <a href="signin" class="btn btn-primary"><fmt:message key="header.label.facebook"/> <i class="fa fa-facebook"></i></a>
                </form>
            </c:if>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6 item-content">
            <h2 class="white"><fmt:message key="about.project.title"/></h2>
            <p class="white"><fmt:message key="about.project.other"/></p>
            <p><a class="btn btn-default" href="/vazilon/contacts.jsp" role="button"><fmt:message key="button.view.details"/> &raquo;</a></p>
        </div>
        <div class="col-md-6 item-content">
            <h2 class="white"><fmt:message key="author.title"/></h2>
            <p class="white"><fmt:message key="author.other"/></p>
            <p><a class="btn btn-default" href="/vazilon/contacts.jsp" role="button"><fmt:message key="button.view.details"/> &raquo;</a></p>
        </div>
    </div>
    ...
    <footer>
        <p class="white item-content"><fmt:message key="last.lable"/></p>
        <script>
            $(function () {
