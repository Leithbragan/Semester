                    ...
                    <c:if test="${user.role=='ADMIN'||user.role=='GUIDE'}">
                        <li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message key="menu.guide"/><span
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#"><fmt:message key="author.top"/></a></li>
                            </ul>
                        </li>
                    </c:if>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            <fmt:message key="about.project.title"/>
            <fmt:message key="about.project.other"/>
            <p><a class="btn btn-default" href="/vazilon/contacts.jsp" role="button">View details &raquo;</a></p>
        </div>
        <div class="col-md-6">
            <fmt:message key="author.title"/>
            <fmt:message key="author.other"/>
            <p><a class="btn btn-default" href="/vazilon/contacts.jsp" role="button">View details &raquo;</a></p>
        </div>
        <%--<div class="col-md-4">--%>
            <%--<fmt:message key="buyer.title"/>--%>

            <%--<p style="color: white">Выбирайте понравившуюся вам экскурсию, добавляйтесь в списки планируемых экскурсий! Путешествуйте с--%>
                <%--нами</p>--%>
    ...
    <footer>
        <p>&copy; Online books shop 2016</p>
        <script>
            $(function () {
